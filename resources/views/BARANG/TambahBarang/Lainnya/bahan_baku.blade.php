...
<div class="container mt-4">
    ...
    <form action="{{ route('barang.store.bahan_baku') }}" method="POST" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="satuan-item row mb-3 border p-3">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="satuan[0][nama]" class="form-control" required>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Faktor Konversi</label>
                                <input type="number" step="0.0001" name="satuan[0][konversi]"
                                       class="form-control" value="1">
                                <small class="text-muted">Relatif terhadap satuan dasar</small>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Deskripsi Konversi</label>
                                <input type="text" name="satuan[0][deskripsi]" class="form-control"
                                       placeholder="Contoh: 1 kg = 1000 gram">
                            </div>
                            <div class="col-md-1">
                                <div class="form-check mt-4 pt-2">
                                    <input class="form-check-input" type="checkbox" name="satuan[0][default]"
                                           value="on" id="satuan_default_0" checked>
                                    <label class="form-check-label" for="satuan_default_0">
                                        Default
                                    </label>
                                </div>
                            </div>
...
<div id="satuan-template" class="d-none">
    <div class="satuan-item row mb-3 border p-3">
        <div class="row">
            ...
            <div class="col-md-4">
                <input type="number" step="0.0001" name="satuan[__INDEX__][konversi]"
                       class="form-control" value="1">
            </div>
            <div class="col-md-3">
                <input type="text" name="satuan[__INDEX__][deskripsi]" class="form-control"
                       placeholder="Contoh: 1 kg = 1000 gram">
            </div>
            <div class="col-md-1">
...
<script>
    ...
    // Hanya satu satuan default yang bisa dipilih
    document.addEventListener('change', function(e) {
        if (e.target && e.target.name && e.target.name.includes('[default]') && e.target.checked) {
