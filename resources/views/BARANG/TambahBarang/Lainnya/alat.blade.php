                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="kategori" id="kategori" class="form-control">
                            <option value="PERALATAN_UMUM"> Peralatan Umum </option>
                            <option value="PERALATAN_KANTOR"> Peralatan Kantor</option>
                            <option value="PERALATAN_PROYEK"> Peralatan Proyek </option>
                            <option value="INVENTARIS_KENDARAAN"> Inventaris Kendaraan </option>
